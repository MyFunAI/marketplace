from app import app, cache, avatar_uploader, background_image_uploader, easemob
from config import *
    ...
    if request.method == 'POST':
        if 'background_image' in request.files and 'user_type' in request.form:
            ...
            if user:
                ...
                filename = background_image_uploader.save(request.files['background_image'], str(user_id),
                                                          ORIGINAL_PHOTO_FILENAME + ext[1])
